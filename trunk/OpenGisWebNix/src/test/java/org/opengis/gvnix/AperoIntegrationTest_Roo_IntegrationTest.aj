...
import org.opengis.gvnix.AperoDataOnDemand;
...
privileged aspect AperoIntegrationTest_Roo_IntegrationTest {
    ...
    public void AperoIntegrationTest.testCountAperoes() {
        ...
        long count = org.opengis.gvnix.Apero.countAperoes();
    ...
    public void AperoIntegrationTest.testFindApero() {
        org.opengis.gvnix.Apero obj = dod.getRandomApero();
        ...
        obj = org.opengis.gvnix.Apero.findApero(id);
    ...
    public void AperoIntegrationTest.testFindAllAperoes() {
        ...
        java.util.List<org.opengis.gvnix.Apero> result = org.opengis.gvnix.Apero.findAllAperoes();
    ...
    public void AperoIntegrationTest.testFindAperoEntries() {
        ...
        java.util.List<org.opengis.gvnix.Apero> result = org.opengis.gvnix.Apero.findAperoEntries(0, (int) count);
    ...
    public void AperoIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyApero(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.opengis.gvnix.Apero merged =  obj.merge();
        obj.flush();
    ...
    public void AperoIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Apero' failed to initialize correctly", dod.getRandomApero());
        org.opengis.gvnix.Apero obj = dod.getNewTransientApero(Integer.MAX_VALUE);
    ...
    public void AperoIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Apero' with identifier '" + id + "'", org.opengis.gvnix.Apero.findApero(id));
    }
