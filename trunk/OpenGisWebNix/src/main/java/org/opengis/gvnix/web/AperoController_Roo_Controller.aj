...
privileged aspect AperoController_Roo_Controller {
    ...
    public String AperoController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String AperoController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        uiModel.addAttribute("apero", Apero.findApero(id));
        return "aperoes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String AperoController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
